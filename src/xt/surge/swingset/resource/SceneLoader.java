...
/**
 * The SceneLoader class handles all loading of scene (*.swsc) files for use in the game. Scene files
...
public class SceneLoader {
     ...
     * @param path The path of the scene file. Can either begin with a resource: prefix or a direct filepath.
